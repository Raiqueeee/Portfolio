...
const getDefaultPanelDimensions = (
    ...
    return {
        about: { width: s(620, 440), height: s(520, 400) },
        projects: { width: s(1100, 820), height: s(760, 560) },
        experience: { width: s(900, 560), height: s(720, 520) },
        message: { width: s(1100, 820), height: s(700, 500) },
        stack: { width: s(700, 480), height: s(450, 320) },
        achievements: { width: s(900, 520), height: s(620, 380) },
    }
}
            ...
            {isMobile ? (
                ...
                <footer className="flex-none bg-background/80 backdrop-blur-sm border-t border-border py-2">
                    <div className="px-8 flex items-center">
                        <div className="w-full flex items-center justify-center z-[9999]">
                            <Dock
